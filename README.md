# Picovoice SDK for Arduino boards - Italian language
...
1. Compile and upload the `Picovoice_IT/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
